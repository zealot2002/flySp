...
public class SPContentProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        if (type.equals(TYPE_GET_ALL)){
            Map<String, ?> all = ContentProviderImpl.getAll(getContext());
            if (all!=null) {
    ...
    public String getType(Uri uri) {
        ...
        if (type.equals(TYPE_CONTAIN)){
            return ContentProviderImpl.contains(getContext(),key)+"";
        }
        return  ""+ ContentProviderImpl.get(getContext(),key,type);
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        if (obj!=null)
            ContentProviderImpl.save(getContext(),key,obj);
        return null;
    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        if (type.equals(TYPE_CLEAN)){
            ContentProviderImpl.clear(getContext());
            return 0;
        }
        String key=path[2];
        if (ContentProviderImpl.contains(getContext(),key)){
            ContentProviderImpl.remove(getContext(),key);
        }
        return 0;
    }
